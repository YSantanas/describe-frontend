  ...
  formulario.addEventListener('submit', function (event) {
      ...
      success: function (response) {
        ...
        response.results.forEach(function (resultado) {
          ...
          div.innerHTML = `
            ...
            <a href="${resultado.url}">${truncate(
            resultado.description.replace('Web', ''),
            100
          )}</a>
            </div>
          `;
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        <div class="contenedor-titulo">
        <div class="formaDos"></div>
        <a href="${resultado2.url}">${truncate(
            resultado2.description.replace('Web', ''),
            100
          )}</a>
        </div>
      `;
          datosDiv2.appendChild(div);
        });
      },
    });
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        <div class="contenedor-titulo">
        <div class="formaDos"></div>
        <a href="${resultado3.url}">${truncate(
            resultado3.description.replace('Web', ''),
            100
          )}</a>
        </div>
      `;
